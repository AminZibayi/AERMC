...
3. Note explicit framework references; if absent, infer from risk categorization structure. **CRITICAL: You MUST use direct quotes (verbatim) when extracting the exact ERM system or framework mentioned.**
