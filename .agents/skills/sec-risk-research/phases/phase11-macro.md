...
3. Use `tavily-mcp_tavily_search` to dynamically search for recent macro shocks affecting the industry. Focus on impacts from: rate volatility, tariffs, CRE stress, geopolitical conflict, AI disruption.
...
6. Identify specific exposures the disclosures reveal (e.g., "X bank's $YYY CRE portfolio") — use for Phase 13 scenarios.
...
- Each macro shock must link to a specific firm exposure (e.g., "Bank X's $224.9B CRE portfolio" or "Bank X's $3.4T total credit exposure")
