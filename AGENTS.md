...
> **NOTICE: PROTOCOL REFACTORED INTO AN OPENCODE SKILL**
> The contents of this protocol have been migrated to the `sec-risk-research` skill to reduce complexity and ensure agents always trigger the bulk data fetcher script *before* performing analysis.
...
*(For detailed execution instructions, see `.agents/skills/sec-risk-research/SKILL.md`)*
